...
Revision ID: 0009_market_features_1h
Revises: 0008_market_features_15m
...
revision = "0009_market_features_1h"
down_revision = "0008_market_features_15m"
branch_labels = None
depends_on = None


def upgrade() -> None:
    if _has_table("market_features_1h"):
        return
    op.create_table(
        "market_features_1h",
        ...
        sa.UniqueConstraint("symbol", "window_open_time", name="uq_market_features_1h_symbol_open"),
    )
    op.create_index("ix_market_features_1h_symbol", "market_features_1h", ["symbol"])
    op.create_index("ix_market_features_1h_feature_status", "market_features_1h", ["feature_status"])
    op.create_index(
        "ix_market_features_1h_close_status",
        "market_features_1h",
...
def downgrade() -> None:
    op.drop_index("ix_market_features_1h_close_status", table_name="market_features_1h")
    op.drop_index("ix_market_features_1h_feature_status", table_name="market_features_1h")
    op.drop_index("ix_market_features_1h_symbol", table_name="market_features_1h")
    op.drop_table("market_features_1h")
