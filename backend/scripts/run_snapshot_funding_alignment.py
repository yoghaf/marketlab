...
from app.services.snapshot_funding_alignment import (  # noqa: E402
    MARKET_STATE_TIMEFRAMES,
    SnapshotFundingAlignmentService,
)
from app.services.utils import duration_seconds, json_safe, utcnow  # noqa: E402

LOCK_PATH = ROOT / "data" / "market_state_alignment.lock"
LOCK_STALE_SECONDS = int(os.getenv("MARKETLAB_MARKET_STATE_LOCK_STALE_SECONDS", "3600"))
...
class RunLock:
    ...
    def _remove_stale_lock(self) -> bool:
        ...
        try:
            ...
            pass
        print(f"{utcnow().isoformat()} market_state_alignment removed stale lock at {self.path}: {reason}")
        return True
            ...
            "results": [
                {
                    ...
                    "snapshot_status_counts": result.snapshot_status_counts,
                    "funding_status_counts": result.funding_status_counts,
                }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run local-only snapshot and funding alignment.")
