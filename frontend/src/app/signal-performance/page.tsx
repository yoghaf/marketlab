  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        subtitle="Arsip hasil Signal yang sudah dilog: entry futures, SL, TP, status TP/SL/open, dan total R paper-live. Bukan radar live dan bukan daftar kandidat terbaru."
      />
